...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" name="loginForm" method="post">
   ...
   <input type="radio" name="utype" id="admin" value="1"> Pengurus
   <input type="radio" name="utype" id="participants" value="2">Peserta
    <input type="radio" name="utype" id="coach" value="3">Pengajar
...
<br /><br />
      ...
      <br>
      <a href="forgotpassword.php" style="color:black;" id="forgot">Terlupa kata laluan?</a><br> 
      <br><br>
      <input type="button" class="btnLogin" name="Login" id="btnLogin" value="Daftar Masuk" onClick="validateUser('login');" />
	  <br><br>
      <label>
...
<div id="id02" class="modal">
  ...
  <form class="modal-content" method="post" action="signup_class.php" enctype="multipart/form-data">
    ...
    <div class="container">
      ...
      <p>Sila isi maklumat di bawah.</p>
      <hr>
      <label for="fname"><b>Ambil foto</b></label><br>
      ...
      <input type=radio checked > Peserta
      <input type=radio > Pengajar <br><br>
      
      <p>Dengan membuat akaun ini, anda bersetuju dengan terma dan privasi kami.</p>
	  <br>
      <div class="clearfix">
        <button type="button" onclick="window.location.href='login.php'" class="cancelbtn">Batal</button>
